...
// Show or hide the rounds input based on the selected game mode

modeSelect.addEventListener("change", () => {
    if (modeSelect.value === "bestofx") {
        // changing the css property of roundsInput
...
startGameButton.addEventListener('click', () => {
    ...
    resultDiv.textContent = `Game started in ${modeSelect.value === 'bestofx' ? `Best of ${maxRounds}`: 'Endless'} mode`;
});
...
// Determine the winner based on the user's choice and computer's choice
